...
export default function About() {
  ...
  const handleScroll = () => {
    ...
    if (services.top <= projects.bottom + 2) {
  ...
  return (
    ...
    <div ref={projectsRef} className={`fixed w-full transition-[top]
          duration-300 ${showNav ? "top-[53px]" : "top-0"} z-10 pt-[5px]`}>
      <div
   ...
   <div className="relative top-[120px] pb-[80px] " >
    ...
    {/* </div> */}
      ...
      <div  ref={servicesRef} className={`bottom-0 transition-[top] duration-300 ${showNav ? "top-[112px]" : "top-[59px]"} sticky z-20 pt-[5px] `}>
       
      <div
        className={`absolute border-t inset-0 ${servicesAttached ? "bg-[#E1E3E3]/60 backdrop-blur-sm top-0 left-0 right-0 h-[160%]" : "bg-[#E1E3E3]"}`}
        style={{
          WebkitMaskImage:
            `${servicesAttached ? "linear-gradient(to bottom, black 0%, black 35%, transparent 100%)" : ""}`,
          maskImage:
