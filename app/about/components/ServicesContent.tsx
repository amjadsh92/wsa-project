...
<>
                <div className={`${suisse.className} relative pt-[40px] text-[22px] text-justify p-[20px] w-[80%] pb-[188px] max-[960px]:text-[20px] max-[750px]:text-[18px] max-[600px]:text-[16px] 
