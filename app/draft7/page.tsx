      ...
      <div className=" flex flex-col">
        ...
        <div
          style={{
            ...
            //   backgroundSize: "cover",
            //   backgroundPosition: "center",
            transform: jump ? "translateY(0vh)" : "translateY(65vh)",
          ...
          <div className={`flex z-10 gap-[20px] flex-1`}>
            <div className={`sticky top-[calc(38px)] self-start`}>
              <ul className=" pt-[10vh]">
                <li className={`text-[52.2px] font-[400] pl-2 `}>ABOUT</li>
                <div className="border w-[50vw] font-light"></div>
                <li className={`text-[52.2px] font-[400] pl-2`}>WORK</li>
                <div className="border w-[50vw]"></div>
                <li className={`text-[52.2px] font-[400] pl-2`}>REPOSITORY</li>
                <div className="border w-[50vw]"></div>
              </ul>
            </div>
            ...
            <div className={`mt-[calc(78.3px+10vh)] `}>
              ...
              <div className="sticky top-[40px] z-40 bg-white">
                ...
                <div className="w-[400px] h-[95vh] bg-white z-30"></div>
              </div>
            </div>
          </div>
